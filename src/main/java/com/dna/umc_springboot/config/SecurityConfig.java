...
import com.dna.umc_springboot.config.security.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/members/join", "/members/login","/swagger-ui/**", "/v3/api-docs/**", "/home", "/signup","/members/signup", "/css/**").permitAll()
