...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = 2090219871L;
    ...
    public final com.dna.umc_springboot.domain.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new com.dna.umc_springboot.domain.QTerms(forProperty("terms")) : null;
    }
