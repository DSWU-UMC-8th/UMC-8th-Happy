...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 775317375L;
    ...
    public final com.dna.umc_springboot.domain.QMember member;

    public final com.dna.umc_springboot.domain.QMission mission;

    public final EnumPath<com.dna.umc_springboot.domain.enums.MissionStatus> status = createEnum("status", com.dna.umc_springboot.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.dna.umc_springboot.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.dna.umc_springboot.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
